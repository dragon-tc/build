...
export LLVM_RTLIB_PATH := $(LLVM_PREBUILTS_PATH)/../lib/clang/5.0%/lib/linux/
export AOSP_LLVM_PREBUILTS_PATH := $(LLVM_PREBUILTS_PATH)/../aosp/bin
export AOSP_LLVM_SANITIZER_PATH := prebuilts/clang/host/linux-x86/$(TARGET_DRAGONTC_VERSION)/aosp
...
export AOSP_LLVM_LINK := $(AOSP_LLVM_PREBUILTS_PATH)/lld-link$(BUILD_EXECUTABLE_SUFFIX)
